...
var MessageType_1 = require("../WebSocket/OnMessage/MessageType");
var instances_1 = require("../instances");
var RedisService = /** @class */ (function () {
    function RedisService(redis) {
        if (redis === void 0) { redis = new Client_1.RedisClient(); }
        this.redis = redis;
    }
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, Promise.all([
                            instances_1.roomService.getPublicRooms(),
                            instances_1.roomService.getPrivateRooms(ws.userId),
                        ])];
                    case 1:
                    ...
                    case 2:
                        ...
                        message = {
                            type: MessageType_1.MessageType.ROOMS_STATE,
                            data: { rooms: data },
                        };
                        instances_1.notifier.send(ws, JSON.stringify(message));
                        return [2 /*return*/];
                }
            });
        });
    };
    RedisService.prototype.getRoomState = function (ws, data) {
        return __awaiter(this, void 0, void 0, function () {
            var roomId, room, message_1, roomState, users, message;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        roomId = data.roomId;
                        return [4 /*yield*/, instances_1.roomService.getRoomById(roomId, {
                                _id: 1,
                                public: 1,
                                ownerId: 1,
                            })];
                    case 1:
                        ...
                        if (!room.public) {
                            if (room.ownerId !== ws.userId) {
                                message_1 = {
                                    type: MessageType_1.MessageType.ROOM_STATE,
                                    data: { _id: roomId, users: 0 },
                                };
                                instances_1.notifier.send(ws, JSON.stringify(message_1));
                                return [2 /*return*/];
                            }
                        }
    ...
    RedisService.prototype.verifyRoomState = function (roomId, userId) {
        return __awaiter(this, void 0, void 0, function () {
            var users;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        users = (_a.sent());
                        if (!users.find(function (u) { return u.userId === userId; }))
                ...
                switch (_a.label) {
                    ...
                    case 5:
                        if (user.socketId.length > 0)
                            return [2 /*return*/];
                        instances_1.notifier.sendToRoom(MessageType_1.MessageType.SIGNOUT_ROOM, roomId, {
                            nickname: user.nickname,
                            users: filtered.length,
                        });
                        return [4 /*yield*/, instances_1.roomService.getRoomById(roomId, { ownerId: 1, public: 1 })];
                    case 6:
                        room = _a.sent();
                        if (room.public) {
                            ...
                            instances_1.notifier.sendToUser(MessageType_1.MessageType.UPDATE_ROOM_STATE, room.ownerId, roomId, { users: filtered.length });
                        }
                        _a.label = 7;
                    ...
                    case 1:
                        ...
                        _loop_1 = function (key) {
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        roomClient = instances_1.roomClients.get(key);
